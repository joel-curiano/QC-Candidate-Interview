...
CREATE TABLE IF NOT EXISTS qc_portal.questions (
    ...
    q_type TEXT NOT NULL CHECK (q_type IN ('mcq', 'essay', 'oral', 'practical')),
...
CREATE TABLE IF NOT EXISTS qc_portal.submissions (
    ...
    oral_max DOUBLE PRECISION NOT NULL DEFAULT 0,
    practical_max DOUBLE PRECISION NOT NULL DEFAULT 0,
